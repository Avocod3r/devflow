  ...
  return (
    <div className="relative mt-11 flex w-full justify-between gap-5 max-sm:flex-col sm:items-center">
      <LocalSearchbar
        ...
        classNames="flex-1 max-sm:w-full"
      />
      ...
      <Select onValueChange={(value) => handleUpdateParams(value)}>
        ...
        <SelectContent className="body-semibold background-light900_dark300 text-dark500_light700 small-regular max-h-[350px] max-w-[250px] border-none">
          <SelectGroup>
            {countriesList ? (
